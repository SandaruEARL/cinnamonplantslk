        ...
        builder: (context, state) {
          ...
          return StreamBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Filter out invalid chats (same user chatting with themselves)
              final allChats = snapshot.data ?? [];
              final validChats = allChats.where((chat) {
                final participants = (chat['participants'] as List?)?.cast<String>() ?? [];
                // Must have exactly 2 different participants
                ...
                itemBuilder: (context, index) {
                  ...
                  return FutureBuilder(
                    ...
                    builder: (context, userSnapshot) {
                      ...
                      final lastMessageTimeStr = chat['lastMessageTime'] as String?;

                      if (lastMessageTimeStr == null) {
                        return const SizedBox.shrink();
                      }

                      final lastMessageTime = DateTime.parse(lastMessageTimeStr);
