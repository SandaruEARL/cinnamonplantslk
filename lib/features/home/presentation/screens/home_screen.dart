...
import '../../../location/presentation/screens/my_locations_screen.dart';
import '../../../marketplace/presentation/bloc/marketplace_bloc.dart';
import '../../../marketplace/presentation/bloc/marketplace_state.dart';
...
import '../../../location/domain/entities/business_location_entity.dart';
            ...
            BlocBuilder<MarketplaceBloc, MarketplaceState>(
              builder: (context, state) {
                ...
                if (state is MarketplaceLoaded) {
                  ...
                  final recent = state.ads.take(5).toList();
                  return SizedBox(
                    height: 280,
